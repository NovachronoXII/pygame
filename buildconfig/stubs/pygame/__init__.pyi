from typing import Any, Tuple, Callable, Optional, overload, Type, NoReturn
...
from pygame import mixer_music as mixer_music  # alias for mixer.music
...
# functions that are not a documented part of pygame API, kept here to make
# stubtest happy
def get_array_interface(arg: Any) -> dict: ...
def segfault() -> None: ...  # TODO: remove when implementation is removed
